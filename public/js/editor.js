...
//reader.readAsDataURL(f);	
					//reader.onload = (function(e){
						...
						// function(e){
							...
							$('.getBchng').append('<input type="hidden" class="filenAme" name="filenAme[]" value="'+e+'">');
						   ...
						   'insert_img'	: { "modal": true,
											...
											"onSave": function(){
												...
												if($('#imageList').data('current')){
													...
													methods.showMessage.apply(this,["imgErrMsg","Please click on image"]);
													return false;
												}
